"""
Django settings for coala_web project.
...
SECRET_KEY = 'o%3(1d(c)#p#_-c!#*!1*e(@l9#lg!-7xia*g0ps$vt2zcby*h'
...
WSGI_APPLICATION = 'coala_web.wsgi.application'
